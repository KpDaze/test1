...
function makeStyles(colors: Palette) {
  return StyleSheet.create({
    ...
    heroTitle: { color: colors.onSurface, fontSize: 15, fontWeight: "900" },
    heroText: { color: colors.muted, fontSize: 10, lineHeight: 14, marginTop: 2 },
    ...
    actionText: { color: colors.onBrandTertiary, fontSize: 12, fontWeight: "900" },
    ...
    noticeTitle: { color: colors.onBrandTertiary, fontSize: 11, fontWeight: "900" },
    noticeText: { color: colors.onBrandTertiary, fontSize: 10, lineHeight: 14, flex: 1 },
    ...
    detectedTitle: { color: colors.onBrandTertiary, fontSize: 13, fontWeight: "900" },
    detectedRange: { color: colors.onBrandTertiary, fontSize: 10, opacity: 0.76, marginTop: 2 },
    hoursPill: { backgroundColor: colors.surfaceSecondary, borderRadius: radius.pill, paddingHorizontal: 9, paddingVertical: 5 },
    hoursPillText: { color: colors.brand, fontSize: 11, fontWeight: "900" },
    ...
    statValue: { color: colors.onSurface, fontSize: 17, fontWeight: "900", marginTop: 3 },
    comparedRange: { color: colors.muted, fontSize: 9, marginTop: 10 },
    infoStrip: { flexDirection: "row", gap: 5, backgroundColor: colors.brandTertiary, borderRadius: 10, padding: 8, marginTop: 8 },
    infoText: { color: colors.onBrandTertiary, fontSize: 9, lineHeight: 13, flex: 1 },
    ...
    differenceLabel: { color: colors.onSurfaceSecondary, fontSize: 12, fontWeight: "800" },
    differenceValue: { fontSize: 19, fontWeight: "900" },
    help: { color: colors.muted, fontSize: 10, lineHeight: 14, marginTop: 10 },
    helpNoTop: { color: colors.muted, fontSize: 10, lineHeight: 14 },
    ...
    adjustmentDate: { color: colors.onSurface, fontSize: 13, fontWeight: "900" },
    ...
    miniValue: { color: colors.onSurface, fontSize: 16, fontWeight: "900", marginTop: 2 },
    clearButton: { alignItems: "center", backgroundColor: colors.brandTertiary, borderRadius: 12, paddingVertical: 11, marginTop: 10 },
    clearText: { color: colors.onBrandTertiary, fontSize: 11, fontWeight: "900" },
    ...
    primaryText: { color: colors.onBrandPrimary, fontSize: 11, fontWeight: "900" },
  });
}
