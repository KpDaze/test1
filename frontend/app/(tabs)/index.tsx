        ...
        <View style={styles.payCard} testID="totals-card" {...periodPanResponder.panHandlers}>
          <View style={styles.payTopRow}>
            ...
            <Pressable testID="dashboard-payslip-btn" onPress={() => router.push("/payslip")} style={styles.payslipBtn}>
              <Text allowFontScaling={false} style={styles.payslipBtnText}>View payslip</Text>
...
function makeStyles(colors: Palette, visual: ReturnType<typeof useDesignSystem>["visual"], useMockupLight: boolean, layout: HomeLayout) {
  ...
  const railNodeTop = 25;
  const railNodeSize = 10;
  ...
  return StyleSheet.create({
    ...
    greetingSub: { color: muted, fontFamily: fonts.text, ...typeScale.body, marginTop: 1 },
    greetingRight: {
    ...
    payCard: {
      ...
      shadowOpacity: useMockupLight ? 0.05 : 0.12,
      shadowRadius: 5,
      shadowOffset: { width: 0, height: 2 },
      elevation: 1,
    },
    payTopRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 8 },
    payTitleWrap: { flexDirection: "row", alignItems: "center", gap: 8, flex: 1, minWidth: 0 },
    payTitleText: { flex: 1, minWidth: 0 },
    clockCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: aqua, alignItems: "center", justifyContent: "center" },
    iconClock: { width: 22 },
    payEyebrow: { color: deep, fontFamily: fonts.textBold, ...typeScale.eyebrow },
    payRange: { color: deep, fontFamily: fonts.textMedium, ...typeScale.bodySmall, marginTop: 1 },
    payOffset: { color: activeTeal, fontFamily: fonts.textMedium, ...typeScale.changed, marginTop: 2 },
    payslipBtn: {
      flexDirection: "row",
      alignItems: "center",
      backgroundColor: aqua,
    ...
    payslipBtnText: { color: activeTeal, fontFamily: fonts.textMedium, ...typeScale.label },
    iconPayChevron: { width: 13 },
    payLoader: { marginVertical: 12 },
    payStats: { flexDirection: "row", alignItems: "stretch", marginTop: 9, minHeight: 44 },
    statCell: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: compact ? 1 : 2 },
    statDivider: { width: 1, backgroundColor: divider, marginVertical: 2 },
    statValue: { color: text, fontFamily: fonts.displayBold, ...typeScale.statValue, fontSize: 18, lineHeight: 22, textAlign: "center" },
    statLabel: { color: muted, fontFamily: fonts.textMedium, ...typeScale.statLabel, fontSize: 10.5, lineHeight: 13, marginTop: 2, textAlign: "center" },

    upcomingHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 9 },
    upcomingTitleWrap: { flexDirection: "row", alignItems: "center", gap: 7 },
    iconCalendar: { width: 22 },
    upcomingTitle: { color: text, fontFamily: fonts.displayBold, ...typeScale.sectionTitle, fontSize: 19, lineHeight: 23 },
    seeAllBtn: { flexDirection: "row", alignItems: "center", gap: 2, paddingVertical: 5, paddingLeft: 8 },
    seeAllText: { color: activeTeal, fontFamily: fonts.textMedium, ...typeScale.action },
    iconSeeAll: { width: 14 },

    timeline: { paddingBottom: 4 },
    shiftRow: { flexDirection: "row", minHeight: 72, paddingBottom: 7 },
    dateTile: {
      width: compact ? 46 : 48,
      height: 58,
      borderRadius: 11,
    ...
    dateDay: { color: text, fontFamily: fonts.displayBold, ...typeScale.dateDay, fontSize: 18, lineHeight: 20 },
    dateMonth: { color: deep, fontFamily: fonts.textMedium, ...typeScale.dateMeta, fontSize: 9.5, lineHeight: 11, letterSpacing: 0.2 },
    dateWeekday: { fontFamily: fonts.textBold, ...typeScale.dateWeekday, fontSize: 9, lineHeight: 11, marginTop: 1 },
    railColumn: { width: compact ? 24 : 26, alignItems: "center", position: "relative" },
    ...
    shiftCard: {
      ...
      position: "relative",
      shadowColor: visual.steel,
      shadowOpacity: useMockupLight ? 0.035 : 0.08,
      shadowRadius: 3,
      shadowOffset: { width: 0, height: 1 },
      elevation: 1,
    },
    shiftTopLine: { flexDirection: "row", alignItems: "center", minHeight: 21, gap: 6 },
    shiftIdentity: { flex: 1, minWidth: 0, flexDirection: "row", alignItems: "center", gap: compact ? 3 : 5 },
    shiftTime: { color: text, fontFamily: fonts.displayBold, ...typeScale.shiftTime, fontSize: 15.5, lineHeight: 19, flexShrink: 1 },
    shiftTypeBadge: {
      flexDirection: "row",
      alignItems: "center",
      gap: 4,
    ...
    duration: { color: deep, fontFamily: fonts.text, ...typeScale.duration, fontSize: 10.5, lineHeight: 13, minWidth: 28, textAlign: "right" },
    houseRow: { flexDirection: "row", alignItems: "center", marginTop: 3, paddingRight: 2 },
    housePill: {
      maxWidth: "100%",
      flexDirection: "row",
      alignItems: "center",
    ...
    cardMetaLine: { minHeight: 12, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 5, marginTop: 2 },
    secondaryText: { color: muted, fontFamily: fonts.text, ...typeScale.metadata, fontSize: 10, lineHeight: 12, flex: 1, minWidth: 0 },
    secondarySpacer: { flex: 1 },
    changedText: { fontFamily: fonts.textMedium, ...typeScale.changed, flexShrink: 0 },
    cardChevron: { position: "absolute", right: 8, top: "50%", transform: [{ translateY: -9 }] },
    iconCardChevron: { width: 18 },
