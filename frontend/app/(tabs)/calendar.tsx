...
function makeStyles(colors: Palette) {
  return StyleSheet.create({
    ...
    screenTitle: { color: colors.onSurface, fontSize: 29, lineHeight: 31, fontWeight: "900", letterSpacing: -0.8 },
    ...
    monthTitle: { color: colors.onSurface, fontSize: 20, fontWeight: "900" },
    swipeHint: { color: colors.muted, fontSize: 10, marginTop: 2 },
    weekRow: { flexDirection: "row", marginBottom: 4 },
    weekDay: { flex: 1, textAlign: "center", color: colors.muted, fontSize: 10, fontWeight: "800", letterSpacing: 1 },
    ...
    cellText: { color: colors.onSurfaceSecondary, fontSize: 14, fontWeight: "700" },
    ...
    eyebrow: { color: colors.brand, fontSize: 10, fontWeight: "800", letterSpacing: 1.6 },
    selectedTitle: { color: colors.onSurface, fontSize: 23, fontWeight: "900", marginTop: 2 },
    selectedDate: { color: colors.muted, fontSize: 12, marginTop: 1 },
    countPill: { backgroundColor: colors.brandTertiary, paddingHorizontal: 10, paddingVertical: 6, borderRadius: radius.pill },
    countText: { color: colors.onBrandTertiary, fontSize: 11, fontWeight: "800" },
    ...
    fortnightLabel: { color: colors.brand, fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
    fortnightRange: { color: colors.onSurface, fontSize: 13, fontWeight: "800", marginTop: 2 },
    fortnightHint: { color: colors.muted, fontSize: 10, marginTop: 2, lineHeight: 14 },
    ...
    emptyTitle: { color: colors.onSurface, fontSize: 17, fontWeight: "900", marginTop: 9 },
    ...
    shiftTime: { color: colors.onSurface, fontSize: 20, fontWeight: "900", letterSpacing: -0.4 },
    duration: { color: colors.onSurfaceSecondary, fontSize: 11, fontWeight: "700", marginLeft: "auto" },
    ...
    houseText: { color: colors.onBrandTertiary, fontSize: 11, fontWeight: "800", flexShrink: 1 },
    ...
    alarmText: { color: colors.muted, fontSize: 10, fontWeight: "600" },
