...
import { useTheme, COLOR_THEMES, radius, type Palette, type ThemeMode, type ClockFormat } from "@/src/theme";
...
function makeStyles(colors: Palette) {
  return StyleSheet.create({
    ...
    label: { color: colors.onSurfaceSecondary, fontSize: 12, fontWeight: "800", marginBottom: 7 },
    subLabel: { color: colors.onSurfaceSecondary, fontSize: 12, fontWeight: "800", marginTop: 17, marginBottom: 7 },
    help: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 7 },
    helpNoTop: { color: colors.muted, fontSize: 11, lineHeight: 16 },
    helpCompact: { color: colors.muted, fontSize: 10, lineHeight: 14, marginTop: 2 },
    input: { flex: 1, backgroundColor: colors.surface, color: colors.onSurface, borderWidth: 1, borderColor: colors.border, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, fontSize: 14 },
    inlineRow: { flexDirection: "row", alignItems: "center", gap: 8 },
    primarySmall: { backgroundColor: colors.brand, borderRadius: 12, paddingHorizontal: 15, paddingVertical: 12 },
    primarySmallText: { color: colors.onBrandPrimary, fontSize: 12, fontWeight: "800" },
    ...
    dowText: { color: colors.onSurfaceSecondary, fontSize: 11, fontWeight: "800" },
    ...
    anchorText: { color: colors.onSurface, fontSize: 14, fontWeight: "700" },
    ...
    stepText: { color: colors.onBrandTertiary, fontSize: 10, fontWeight: "800" },
    ...
    reminderTitle: { color: colors.onSurface, fontSize: 14, fontWeight: "900" },
    ...
    secondaryButtonText: { color: colors.onBrandTertiary, fontSize: 11, fontWeight: "800" },
    ...
    statusText: { color: colors.onSurfaceSecondary, fontSize: 11, lineHeight: 16, marginTop: 10 },
    ...
    currency: { color: colors.brand, fontSize: 18, fontWeight: "900" },
    rateInput: { flex: 1, color: colors.onSurface, fontSize: 15, paddingHorizontal: 8, paddingVertical: 11 },
    rateSuffix: { color: colors.muted, fontSize: 12, fontWeight: "700" },
    ...
    houseName: { color: colors.onSurface, fontSize: 14, fontWeight: "900", flexShrink: 1 },
    houseAddress: { color: colors.muted, fontSize: 10, marginTop: 2 },
    houseRate: { color: colors.brand, fontSize: 11, fontWeight: "800", marginTop: 3 },
    defaultPill: { backgroundColor: colors.brandTertiary, borderRadius: radius.pill, paddingHorizontal: 7, paddingVertical: 3 },
    defaultText: { color: colors.onBrandTertiary, fontSize: 8, fontWeight: "900", letterSpacing: 0.8 },
    ...
    themeName: { color: colors.onSurface, fontSize: 12, fontWeight: "900" },
    themeDescription: { color: colors.muted, fontSize: 9, marginTop: 1 },
