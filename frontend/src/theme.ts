...
// Chosen ShiftMate mock-up light palette. Exact picker samples are recorded in
// SHIFT_MATE_VISUAL_REFERENCE.md and src/mockupPalette.ts.
...
const LAVENDER_DARK: Palette = {
  surface: "#17131B",
  onSurface: "#F4EFF8",
  surfaceSecondary: "#211B27",
  onSurfaceSecondary: "#E1D8E8",
  surfaceTertiary: "#30273A",
  onSurfaceTertiary: "#C9BCD5",
  surfaceInverse: "#F1EBF5",
  onSurfaceInverse: "#17131B",
  brand: "#B79AD2",
  brandPrimary: "#B79AD2",
  onBrandPrimary: "#25162F",
  brandSecondary: "#8E6DB0",
  onBrandSecondary: "#F7F0FB",
  brandTertiary: "#3A2948",
  onBrandTertiary: "#E4D3F0",
  ...SEMANTIC,
  successSurface: "#1D3A26",
  warningSurface: "#3A3115",
  onWarningSurface: "#F4DFAC",
...
const LAVENDER_LIGHT: Palette = {
  ...
  onSurfaceSecondary: "#2E2935",
  surfaceTertiary: "#EEE9F5",
  onSurfaceTertiary: "#443B52",
  surfaceInverse: "#211B29",
  onSurfaceInverse: "#F7F3FA",
  brand: "#76589B",
  brandPrimary: "#76589B",
  onBrandPrimary: "#FFFFFF",
  brandSecondary: "#A88BC5",
  onBrandSecondary: "#21152E",
  brandTertiary: "#E9DEF4",
  onBrandTertiary: "#4A3165",
  ...SEMANTIC,
  successSurface: "#DDEEE3",
  warningSurface: "#F4E6C4",
  onWarningSurface: "#4A3507",
  errorSurface: "#F4DDDA",
  onErrorSurface: "#5E1712",
...
const WARM_DARK: Palette = {
  surface: "#181512",
  onSurface: "#F4EEE6",
  surfaceSecondary: "#221E1A",
  onSurfaceSecondary: "#DED5CA",
  surfaceTertiary: "#302A24",
  onSurfaceTertiary: "#C8BAA8",
  surfaceInverse: "#EFE7DD",
  onSurfaceInverse: "#181512",
  brand: "#C7A87B",
  brandPrimary: "#C7A87B",
  onBrandPrimary: "#2A2117",
  brandSecondary: "#9C7C56",
  onBrandSecondary: "#FAF3E9",
  brandTertiary: "#413323",
  onBrandTertiary: "#F0DCC2",
  ...SEMANTIC,
  successSurface: "#1D3A26",
  warningSurface: "#3A3115",
  onWarningSurface: "#F4DFAC",
...
const WARM_LIGHT: Palette = {
  surface: "#F8F5EF",
  onSurface: "#241F1A",
  surfaceSecondary: "#FFFDF9",
  onSurfaceSecondary: "#342E27",
  surfaceTertiary: "#EEE7DD",
  onSurfaceTertiary: "#4D4338",
  surfaceInverse: "#2A241E",
  onSurfaceInverse: "#FBF6EE",
  brand: "#8A6A45",
  brandPrimary: "#8A6A45",
  onBrandPrimary: "#FFFFFF",
  brandSecondary: "#B89A76",
  onBrandSecondary: "#2D241B",
  brandTertiary: "#EDE1D1",
  onBrandTertiary: "#5A4127",
  ...SEMANTIC,
  successSurface: "#DDEEE3",
  warningSurface: "#F4E6C4",
  onWarningSurface: "#4A3507",
...
const OCEAN_DARK: Palette = {
  surface: "#101820",
  onSurface: "#EDF4F8",
  surfaceSecondary: "#18232D",
  onSurfaceSecondary: "#D6E2E9",
  surfaceTertiary: "#243440",
  onSurfaceTertiary: "#B9CBD5",
  surfaceInverse: "#EAF1F5",
  onSurfaceInverse: "#101820",
  brand: "#78B8DA",
  brandPrimary: "#78B8DA",
  onBrandPrimary: "#092331",
  brandSecondary: "#4C91B8",
  onBrandSecondary: "#F1F8FC",
  brandTertiary: "#203E50",
  onBrandTertiary: "#C9E8F7",
  ...SEMANTIC,
  successSurface: "#1D3A26",
  warningSurface: "#3A3115",
  onWarningSurface: "#F4DFAC",
...
const OCEAN_LIGHT: Palette = {
  ...
  onSurface: "#14212A",
  surfaceSecondary: "#FFFFFF",
  onSurfaceSecondary: "#263742",
  surfaceTertiary: "#E4EFF5",
  onSurfaceTertiary: "#36505F",
  surfaceInverse: "#14232C",
  onSurfaceInverse: "#F2F8FB",
  brand: "#356F94",
  brandPrimary: "#356F94",
  onBrandPrimary: "#FFFFFF",
  brandSecondary: "#72A9C8",
  onBrandSecondary: "#102A39",
  brandTertiary: "#DCECF5",
  onBrandTertiary: "#244E67",
  ...SEMANTIC,
  successSurface: "#DDEEE3",
  warningSurface: "#F4E6C4",
  onWarningSurface: "#4A3507",
...
export const COLOR_THEMES: {
...
}[] = [
  {
    key: "teal",
    label: "Original Teal",
    description: "Chosen ShiftMate mock-up colours",
    swatches: ["#41A299", "#E1F3F2", "#112130"],
  },
  {
    key: "lavender",
    label: "Soft Lavender",
    description: "Cool purple with softer contrast",
    swatches: ["#76589B", "#E9DEF4", "#17131B"],
  },
  {
    key: "warm",
    label: "Warm Neutral",
    description: "Sand, stone and warm brown",
    swatches: ["#8A6A45", "#EDE1D1", "#181512"],
  },
  {
    key: "ocean",
    label: "Ocean Blue",
    description: "Clear blue with cool slate tones",
    swatches: ["#356F94", "#DCECF5", "#101820"],
  },
];
...
// The repository does not ship Barlow Condensed or DM Sans. Use fonts that are
// actually present on the platform instead of naming unavailable bundled assets.
export const fonts = {
...
// Shared type roles. Screen-specific layout may adjust wrapping/width, but should
// not invent a new font size for a role that already exists here.
    ...
    (async () => {
      try {
        const [storedTheme, storedColorTheme, storedClock] = await Promise.all([
          storage.getItem(THEME_STORAGE_KEY, "dark" as ThemeMode),
        ...
        if (storedClock === "12h" || storedClock === "24h") {
          setClockFormatState(storedClock);
        }
      } catch {}
    })();
